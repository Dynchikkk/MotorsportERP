...
public class MediaFileService : IMediaFileService
{
    ...
    public MediaFileService(IFileRepository fileRepository, IOptions<MediaFileStorageSettings> options)
    {
        _fileRepository = fileRepository;
        _settings = options.Value;
    }

    public async Task<MediaFileResponce> UploadImageAsync(Stream fileStream, string fileName, Guid? userId = null)
    {
        ...
        return new MediaFileResponce { Id = mediaFile.Id, Url = mediaFile.SavedUrl };
    }
